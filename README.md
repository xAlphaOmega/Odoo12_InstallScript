...
```
sudo wget https://raw.githubusercontent.com/bassammannaa/InstallScript/12.0/odoo_install.sh
sudo wget https://raw.githubusercontent.com/bassammannaa/InstallScript/12.0/ubuntu_install.sh
```
